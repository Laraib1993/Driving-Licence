<%@ Page Title="" Language="C#" MasterPageFile="~/Reseller.master" AutoEventWireup="true" CodeFile="ResellerEditPrductForm.aspx.cs" Inherits="ResellerEditPrductForm" %>
                                                             ...
                                                             <div class="form-group row">
                                                                                ...
                                                                                <div class="form-group row">
                                                                                   ...
                                                                                   <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-md-8 col-lg-10">
                                                                                        <select id="txtproductcategory" runat="server" name="select" class="form-control form-control-primary" required="required">
                                                                                    ...
                                                                                    <div class="col-md-8 col-lg-10">
                                                                                        <select id="txtproducttype" runat="server" name="select" class="form-control form-control-primary" required="required">
