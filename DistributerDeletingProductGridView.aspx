<%@ Page Title="" Language="C#" MasterPageFile="~/Distributer.master" AutoEventWireup="true" CodeFile="DistributerDeletingProductGridView.aspx.cs" Inherits="DistributerDeletingProductGridView" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Distibuter List</h5>
                                            <p class="m-b-0">All Delete Distibuter List</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                                    ...
                                                    <div>
                                                        <asp:GridView ID="gvtblImages" runat="server" AutoGenerateColumns ="false" DataKeyNames="PID" CssClass="table table-striped table-bordered nowrap" ShowHeaderWhenEmpty="true"> 
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField ="Launchdate" HeaderText ="Launch Date" />
