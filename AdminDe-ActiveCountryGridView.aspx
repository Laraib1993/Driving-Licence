<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminDe-ActiveCountryGridView.aspx.cs" Inherits="AdminDe_ActiveCountryGridView" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">All De-Actived Country List</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                <div class="dt-responsive table-responsive">
                                                    ...
                                                    <div>
                                                        <asp:GridView ID="gvtblImages" runat="server" AutoGenerateColumns ="false" DataKeyNames="CountID" CssClass="table table-striped table-bordered nowrap" ShowHeaderWhenEmpty="true"> 
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField ="CountID" HeaderText ="CountID" />
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="LnkSelect" data-toggle="tooltip" runat="server" CssClass="txt-muted" data-placement="top" title="" data-original-title="Delete" OnClick="LnkSelect_Click" CommandArgument='<%# Eval("CountID")%>'>
