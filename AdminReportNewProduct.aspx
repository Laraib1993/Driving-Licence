<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminReportNewProduct.aspx.cs" Inherits="AdminReportNewProduct" %>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="AdminReportNewProduct.aspx">List</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="AdminReportNewProduct.aspx">Product</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="AdminReportNewProduct.aspx">New</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
