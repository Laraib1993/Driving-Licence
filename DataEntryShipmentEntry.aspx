<%@ Page Title="" Language="C#" MasterPageFile="~/DataEntryDashboard.master" AutoEventWireup="true" CodeFile="DataEntryShipmentEntry.aspx.cs" Inherits="DataEntryShipmentEntry" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">New Shipment ID Form</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#">New Shipment Entry</a>
                                            </li>
                                                    ...
                                                    <div class="card-block">
                                                        <form runat ="server">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-8 col-lg-10">
                                                                    <input id="txtreceivedate" runat="server"  class="form-control dropper-default" type="text" placeholder="Select date" />
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group row">
                                                                   ...
                                                                   <div class="col-md-8 col-lg-10">
                                                                       <asp:DropDownList ID="ddlreceiveby" runat="server" class="form-control form-control-primary"></asp:DropDownList>
