...
public partial class AdminNewListDistributerReport : System.Web.UI.Page
{
    ...
    public string getattendance()
    {
        ...
        using (cmd = new SqlCommand())
        {
            ...
            cmd.CommandText = "sp_AdminActiveDistributerReportTop50";
            ...
            using (sdr = cmd.ExecuteReader())
            {
                if (sdr.HasRows)
                {
                    while (sdr.Read())
                    {
                        ...
                        string type = Convert.ToString(sdr[10]);
                        ...
                        data += "<tr><td>" + sno + "</td><td>" + "<img src='" + logo + "' width='80' height='30' />" + "</td><td>"
                            ...
                            + phone + "</td><td>" + type + "</td><td>" + contactpersonname + "</td><td>" + contactpersonemail + "</td><td>" + contactpersonphone + "</td></tr>";
                    }
                }
            }
            return data;
