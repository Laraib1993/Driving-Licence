<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminNewListPatnerReport.aspx.cs" Inherits="AdminNewListPatnerReport" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">All Active New Patner List</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="AdminNewListPatnerReport.aspx">Patner List</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="AdminNewListPatnerReport.aspx">New</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
