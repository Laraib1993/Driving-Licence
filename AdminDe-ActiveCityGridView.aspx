<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminDe-ActiveCityGridView.aspx.cs" Inherits="AdminDe_ActiveCityGridView" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">City List</h5>
                                            <p class="m-b-0">All De-Actived City List</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                <div class="dt-responsive table-responsive">
                                                    ...
                                                    <div>
                                                        <asp:GridView ID="gvtblImages" runat="server" AutoGenerateColumns ="false" DataKeyNames="CID" CssClass="table table-striped table-bordered nowrap" ShowHeaderWhenEmpty="true"> 
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="LnkSelect" data-toggle="tooltip" runat="server" CssClass="txt-muted" data-placement="top" title="" data-original-title="Delete" OnClick="LnkSelect_Click" CommandArgument='<%# Eval("CID")%>'>
