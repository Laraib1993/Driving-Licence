...
<head runat="server">
    <title>Glocali Channel || Registration </title>
         ...
         <fieldset class="">
            ...
            <div class="input-group">
                <select id="slctcompanysize" ClientIDMode="Static" class="form-control" >
                    ...
                    <option value="1 to 10 Employees">11 to 25 Employees</option>
                </select>
                
            </div>
            <div class="input-group">
                <select id="slctrevenue" ClientIDMode="Static" class="form-control" >
                    <option value="-1"> Select Annual Revenue</option>
                    <option value="Less then $ 1 Million">Less then $ 1 Million</option>
                    <option value="$1 to $50 Million">$1 to $50 Million</option>
                    <option value="$51 to $100 Million">$51 to $100 Million</option>
                </select>
            </div>
