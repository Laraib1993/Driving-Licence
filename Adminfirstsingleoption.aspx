<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Adminfirstsingleoption.aspx.cs" Inherits="Adminfirstsingleoption" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Header's Option will be add by admin only</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a href="Dashboard.aspx"> <i class="fa fa-home">Home</i> </a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="Adminfirstsingleoption.aspx">Header's Option</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="Adminfirstsingleoption.aspx">Form</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="card-block">
                                                        <form runat ="server">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input id="txtname" runat="server" type="text" class="form-control" name="name" placeholder="For example : Subscription, Dashboard">
