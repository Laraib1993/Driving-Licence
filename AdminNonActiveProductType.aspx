<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminNonActiveProductType.aspx.cs" Inherits="AdminNonActiveProductType" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Non Actove Product Type List</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="AdminNewProductTypeReport.aspx">Product Type List</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="AdminNewProductTypeReport.aspx">Non Active</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
