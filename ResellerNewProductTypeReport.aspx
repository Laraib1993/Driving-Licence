<%@ Page Title="" Language="C#" MasterPageFile="~/Reseller.master" AutoEventWireup="true" CodeFile="ResellerNewProductTypeReport.aspx.cs" Inherits="ResellerNewProductTypeReport" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">All New Product Type List</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="ResellerNewProductTypeReport.aspx">Product Type List</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="ResellerNewProductTypeReport.aspx">New</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
