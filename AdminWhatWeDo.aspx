<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminWhatWeDo.aspx.cs" Inherits="AdminWhatWeDo" %>
                                                    ...
                                                    <div class="card-block">
                                                        <form runat ="server">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input id="txtheading" runat="server" type="text" class="form-control" name="name" placeholder="Heading e.g What We Do">
