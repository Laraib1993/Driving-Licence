<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminNonActiveResellerReport.aspx.cs" Inherits="AdminNonActiveResellerReport" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Non Active Reseller List</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="AdminNonActiveResellerReport.aspx">Reseller List</a>
                                            </li>
                                             <li class="breadcrumb-item"><a href="AdminNonActiveResellerReport.aspx">Non Active</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Non Active Reseller List</h5>
