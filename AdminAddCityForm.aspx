<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminAddCityForm.aspx.cs" Inherits="AdminAddCityForm" %>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="AdminAddCityForm.aspx">City</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="AdminAddCityForm.aspx">Form</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                        ...
                                                        <form runat ="server">
                                                          ...
                                                          <div class="form-group row">
                                                             <div class="col-md-4 col-lg-2">
                                                                 <label for="userName-1" class="block">Country</label>
                                                             </div>
                                                             <div class="col-md-8 col-lg-10">
                                                                 <select id="slctcountry" runat="server" name="select" class="form-control form-control-primary" required="required">
