<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminAddPatnerBranchForm.aspx.cs" Inherits="AdminAddPatnerBranchForm" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Scanning Inword Form</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="AdminAddPatnerBranchForm.aspx">Scanning Inword</a>
                                            </li>
                                                        ...
                                                        <form runat ="server">
                                                             <div class="form-group row">
                                                                  ...
                                                                  <div class="col-md-8 col-lg-10 js-default js-primary js-success js-info js-warning js-inverse js-danger js-large js-medium js-small js-single js-dynamic-state js-dynamic-enable js-dynamic-disable m-t-10">
                                                                       <input id="txtinwordno" type="text" class="form-control required thresold-i" runat="server" placeholder="Type your inword no here " maxlength="10">
                                                                  </div>
                                                              </div>
                                                            ...
                                                            <%--<div class="form-group row">
                                                                 ...
                                                                 <div class="col-md-8 col-lg-10">
                                                                     <select id="slctreason" runat="server" name="select" class="form-control form-control-primary" required="required">
                                                                         <option value="opt1">Select Reason</option>
                                                            ...
                                                            <div class="form-group row">
                                                                 <div class="col-md-4 col-lg-2">
                                                                     <label for="userName-1" class="block">Department</label>
                                                                 </div>
                                                                 <div class="col-md-8 col-lg-10">
                                                                     <select id="slctdepartment" runat="server" name="select" class="form-control form-control-primary" required="required">
                                                          ...
                                                          <%--<div class="form-group row">
                                                            ...
                                                            <%--<div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Modification</label>
                                                                <div class="col-sm-10">
                                                                    <input id="txtModification" runat="server" type="text" class="form-control" name="name" placeholder="No Of Modification's">
                                                                    <span class="messages"></span>
                                                                </div>
                                                            </div>--%>
