<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminTranparentArea.aspx.cs" Inherits="AdminTranparentArea" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Transparent Area</title>
</asp:Content>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Transparent Area Form</h5>
                                            <p class="m-b-0">Transparent Area will be updated by admin only</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="AdminTranparentArea.aspx">Transparent Area</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="AdminTranparentArea.aspx">Form</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
