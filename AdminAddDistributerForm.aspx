<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminAddDistributerForm.aspx.cs" Inherits="AdminAddDistributerForm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Admin || Add Distributer Form</title>
</asp:Content>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Distributer Form</h5>
                                            <p class="m-b-0">Add Distributer By Yourselft</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="AdminAddDistributerForm.aspx">Distributer</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="AdminAddDistributerForm.aspx">Form</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div id="wizard">
                                                                    <section >
                                                                        <form  class="distributer-forms" runat="server" novalidate="novalidate">
