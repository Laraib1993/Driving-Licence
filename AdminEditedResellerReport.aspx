<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminEditedResellerReport.aspx.cs" Inherits="AdminEditedResellerReport" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">All Updated Reseller List</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="AdminEditedResellerReport.aspx">Reseller List</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="AdminEditedResellerReport.aspx">Updated </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
