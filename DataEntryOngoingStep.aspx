<%@ Page Title="" Language="C#" MasterPageFile="~/DataEntryDashboard.master" AutoEventWireup="true" CodeFile="DataEntryOngoingStep.aspx.cs" Inherits="DataEntryOngoingStep" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Ongoing Step</title>
</asp:Content>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">New Ongoing Step Form</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#">New Ongoing Step</a>
                                            </li>
                                                        ...
                                                        <form runat ="server">
                                                            ...
                                                            <div class="form-group row">
                                                             ...
                                                             <div class="form-group row">
                                                                   ...
                                                                   <div class="col-md-8 col-lg-10">
                                                                       <asp:DropDownList ID="ddlrider" runat="server" class="form-control form-control-primary"></asp:DropDownList>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-8 col-lg-10">
                                                                    <input id="txtassignedon" runat="server"  class="form-control dropper-default" type="text" placeholder="Select date" />
                                                                </div>
                                                            </div>
