<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminDeletedVendorReport.aspx.cs" Inherits="AdminDeletedVendorReport" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Deleted Vendor List</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="AdminDeletedVendorReport.aspx">Vendor List</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="AdminDeletedVendorReport.aspx">Deleted </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
