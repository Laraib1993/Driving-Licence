<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminAddPatnerForm.aspx.cs" Inherits="AdminResellerForm" %>
...
<%--    <link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.1/themes/base/jquery-ui.css" rel="stylesheet" type="text/css" />  
    ...
    <title>Admin || Add Patner Form</title>
</asp:Content>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Add Patner By Yourselft</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="AdminAddPatnerForm.aspx">Patner</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="AdminAddPatnerForm.aspx">Form</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div id="wizard">
                                                                    <section >
                                                                        <form  class="exampleadvancedform" runat="server" novalidate="novalidate">
