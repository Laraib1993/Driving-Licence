<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminAddAssignTierLevel.aspx.cs" Inherits="AdminAddAssignTierLevel" %>
                                                            ...
                                                            <div class="form-group row">
                                                             ...
                                                             <div class="col-md-8 col-lg-10">
                                                                 <select id="slcttierlevel" runat="server" name="select" class="form-control form-control-primary" required="required">
                                                                        ...
                                                                        <option value="opt2">Gold</option>
                                                                        <option value="opt3">Silver</option>
                                                                  </select>
                                                             </div>
                                                          </div>
