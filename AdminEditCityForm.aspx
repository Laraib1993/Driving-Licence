<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminEditCityForm.aspx.cs" Inherits="AdminEditCityForm" %>
                                                        ...
                                                        <form  runat="server">
                                                          ...
                                                          <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <asp:Button ID="btn" runat="server" class="btn btn-primary m-b-0" Text="Submit" OnClick="btn_Click" />
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
