<%@ Page Title="" Language="C#" MasterPageFile="~/Reseller.master" AutoEventWireup="true" CodeFile="ResellerAddProductForm.aspx.cs" Inherits="ResellerAddProductForm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Reseller Product Form</title>
</asp:Content>
                                                        ...
                                                        <form runat="server" >
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-md-8 col-lg-10">
                                                                                        <asp:DropDownList ID="slctproduct" runat="server" AutoPostBack="true" OnSelectedIndexChanged="slctproduct_SelectedIndexChanged" name="select" class="form-control form-control-primary" required="required"></asp:DropDownList>
