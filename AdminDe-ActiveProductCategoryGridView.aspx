<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminDe-ActiveProductCategoryGridView.aspx.cs" Inherits="AdminDe_ActiveProductCategoryGridView" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">All De-Active Product Category List</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>De-Active Product Category List</h5>
                                            ...
                                            <div class="card-block">
                                                <div class="dt-responsive table-responsive">
                                                    ...
                                                    <div>
                                                        <asp:GridView ID="gvtblImages" runat="server" AutoGenerateColumns ="false" DataKeyNames="PCID" CssClass="table table-striped table-bordered nowrap" ShowHeaderWhenEmpty="true"> 
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="LnkSelect" data-toggle="tooltip" runat="server" CssClass="txt-muted" data-placement="top" title="" data-original-title="Delete" OnClick="LnkSelect_Click" CommandArgument='<%# Eval("PCID")%>'>
