<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminAddVendorForm.aspx.cs" Inherits="AdminAddVendorForm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Admin || Add Vendor Form</title>
</asp:Content>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Add Vendor By Yourselft</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="AdminAddVendorForm.aspx">Vendor</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="AdminAddVendorForm.aspx">Form</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div id="wizard">
                                                                    <section >
                                                                        <form  class="basic-forms" runat="server" novalidate="novalidate">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="radio radiofill radio-success radio-inline">
                                                                                    <label>
                                                                                        <input type="radio" name="radio" value="5" ClientIDMode="Static" checked="checked">
