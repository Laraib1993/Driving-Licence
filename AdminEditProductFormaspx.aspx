<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminEditProductFormaspx.aspx.cs" Inherits="AdminEditProductFormaspx" %>
                                                        ...
                                                        <form runat="server">
                                                                                  ...
                                                                                  <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-md-8 col-lg-10">
                                                                                        <asp:DropDownList ID="Slctproduct" runat="server" name="select" class="form-control form-control-primary" AutoPostBack="true" OnSelectedIndexChanged="Slctproduct_SelectedIndexChanged" required="required"></asp:DropDownList>
                                                                                    </div>
                                                                                </div>
