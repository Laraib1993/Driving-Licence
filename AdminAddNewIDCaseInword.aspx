<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminAddNewIDCaseInword.aspx.cs" Inherits="AdminAddNewIDCaseInword" %>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">New ID Case Inword Form</h5>
                                            <p class="m-b-0">Inword will be add by admin only</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="AdminAddProductCategoryForm.aspx">New ID Case</a>
                                            </li>
